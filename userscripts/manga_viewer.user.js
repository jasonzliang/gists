    ...
    */
    ...
    var nsfwimp = [{
        ...
        prev: function () {
            ...
            // Store it in a global variable so it can be accessed later
            var directPrevLink = document.querySelector('#prev');
            if (directPrevLink && directPrevLink.href) {
                // log('Found exhentai prev link in implementation:', directPrevLink.href);
                // window.savedPrevLink = directPrevLink.href;
